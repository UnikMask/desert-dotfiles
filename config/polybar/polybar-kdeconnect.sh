...
WIDTH=12
WIDTH_WIDE=24
THEME=iroh-themes/iroh-panel.rasi

# Color Settings of Icon shown in Polybar
COLOR_DISCONNECTED='#c22211'       # Device Disconnected
COLOR_NEWDEVICE='#00a5a5'          # New Device
COLOR_BATTERY_90='#709489'         # Battery >= 90
COLOR_BATTERY_80='#709489'         # Battery >= 80
COLOR_BATTERY_70='#7b504a'         # Battery >= 70
COLOR_BATTERY_60='#7b504a'         # Battery >= 60
COLOR_BATTERY_50='#7b504a'         # Battery >= 50
COLOR_BATTERY_LOW='#c2401c'        # Battery <  50
